  ...
  return (
    <div className='order-wrap'>
        <div className="order-text-wrap">
            ...
            <button className='btn btn-danger text-white fw-bold fs-5 me-2'>Dine In</button>
            <button className='btn btns btn-light text-danger fw-bold fs-5 me-2'>To Go</button>
            <button className='btn btns btn-light text-danger fw-bold fs-5 me-2'>Delivery</button>
        </div>
